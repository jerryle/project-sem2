    ...
    <div class="card">
        ...
        <div class="card-body mx-4 mt-4">
            <form action="{{route('admin.story.store')}}" method="POST">
                @csrf
                <div class="md-form">
                <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{$story->title}}" required autofocus> @if ($errors->has('title'))
                ...
                <div class="md-form">
                    <textarea id="details" class="ckeditor form-control{{ $errors->has('details') ? ' is-invalid' : '' }}" name="details"
                ...
                <div class="md-form">
                <input id="author" type="text" class="form-control{{ $errors->has('author') ? ' is-invalid' : '' }}" name="author" value="{{$story->author}}" required> @if ($errors->has('author'))
                        <span class="invalid-feedback" role="alert">
