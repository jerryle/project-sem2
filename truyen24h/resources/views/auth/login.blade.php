...
@section('main')
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-6 mb-5 mt-md-0 mt-5 white-text text-center text-md-left">
            ...
            <h6 class="mb-3 wow fadeInLeft" data-wow-delay="0.1s">Vui lòng đăng nhập để trải nghiệm và sử dụng đầy đủ chức năng của truyện24h - Đọc truyện online, đọc truyện chữ, truyện
