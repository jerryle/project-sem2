...
<div class="row mt-5">
    ...
    <div class="col-md-5 mb-4">
        <!--Form-->
        <div class="card wow fadeInRight mr-auto" data-wow-delay="0.1s">
            <div class="card-body">
                <!--Header-->
                ...
                <form action="{{ route('login') }}" method="POST" aria-label="{{ __('auth.login') }}">
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" class="btn purple-gradient btn-lg">{{ __('auth.login')}}</button>
                        ...
                        <div class="inline-ul text-center d-flex justify-content-center">
                            <p class="font-small grey-text d-flex justify-content-end mt-0">{{ __('auth.reset') }}
                                <a href="{{ route('password.request') }}" class="white-text ml-1 font-weight-bold">
                                    {{ __('auth.forgot') }}</a>?
                            </p>
                        </div>
                    </div>
